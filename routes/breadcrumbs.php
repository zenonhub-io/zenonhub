...
Breadcrumbs::for('tools.node-status', function (BreadcrumbTrail $trail) {
    $trail->parent('tools');
    $trail->push('Node status', route('tools.node-status'));
});

Breadcrumbs::for('tools.node-statistics', function (BreadcrumbTrail $trail) {
    $trail->parent('tools');
    $trail->push('Node statistics', route('tools.node-statistics'));
});

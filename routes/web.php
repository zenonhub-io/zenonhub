...
use App\Http\Controllers\Explorer\AccountBlocksController;
...
Route::middleware([
    ...
    Route::get('explorer/blocks', [AccountBlocksController::class, 'index'])->name('explorer.block.list');
    Route::get('explorer/block/{hash}/{tab?}', [AccountBlocksController::class, 'show'])->name('explorer.block.detail');

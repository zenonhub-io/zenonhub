...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('nom_accounts', function (Blueprint $table) {
            ...
            $table->string('znn_locked')->index()->default(0);
            $table->string('qsr_locked')->index()->default(0);
            $table->string('total_znn_balance')->index()->default(0);
            $table->string('total_qsr_balance')->index()->default(0);
            $table->string('total_znn_rewards')->index()->default(0);
            $table->string('total_qsr_rewards')->index()->default(0);
            $table->string('total_znn_sent')->index()->default(0);
            $table->string('total_znn_received')->index()->default(0);
            $table->string('total_qsr_sent')->index()->default(0);
            $table->string('total_qsr_received')->index()->default(0);

<x-app-layout>
            ...
            <div class="d-flex align-items-start flex-column">
                <div class="d-flex align-items-center">
                    ...
                    <h5 class="text-muted ms-3">
                        {{ __('Project') }}
                        <x-copy :text="route('accelerator-z.project.detail', ['hash' => $project->hash])" class="ms-2" :tooltip="__('Copy URL')" />
                    </h5>
                </div>
    ...
    <div class="container-fluid px-3 px-md-6">
        ...
        <div class="row mb-6 gy-6">
            <div class="col-12 col-sm-8">
                <x-cards.card>
                    <x-cards.body>
                        <x-stats.mini-stat :title="__(':znn Requested', ['znn' => app('znnToken')->symbol])">
            ...
            <div class="col-12 col-sm-8">
                <x-cards.card>
                    <x-cards.body>
                        <x-stats.mini-stat :title="__(':qsr Requested', ['qsr' => app('qsrToken')->symbol])">
    ...
    @if ($tab === 'json')
        <div class="mx-3 mx-md-6">
            <x-cards.card>
                <x-cards.body>
                    <x-code-highlighters.json :code="$project->raw_json ?: ['error' => __('Data unavailable, please try again')]" />
                </x-cards.body>
            </x-cards.card>
        </div>
    @endif

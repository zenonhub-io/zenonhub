<div wire:poll.10s>
    <x-cards.card>
        <x-cards.heading class="d-flex align-items-center">
            ...
            <x-link :href="route('explorer.block.list')" class="btn btn-sm btn-outline-primary float-end">
                {{ __('All') }}
                ...
                <div class="list-group-item px-6">
                    <div class="d-block d-md-flex justify-content-between">
                        <div class="mb-2 d-flex align-items-center d-md-block">
                            <x-link :href="route('explorer.block.detail', ['hash' => $block->hash])" class="d-block">
                                <x-hash :hash="$block->hash" :eitherSide="7" :alwaysShort="true" />
                            </x-link>
                            <x-date-time.carbon :date="$block->created_at" :human="true" class="text-xs text-muted ms-2 ms-md-0" />
                        </div>
                        <div class="d-block mb-3 mb-md-0">
                            <span class="d-flex justify-content-start justify-content-md-end align-items-center mb-1">
                                ...
                                <x-address :account="$block->account" :always-short="true" :either-side="6" />
                                <span class="ms-2">
                            ...
                            <span class="d-flex justify-content-start justify-content-md-end align-items-center">
                                ...
                                <x-address :account="$block->toAccount" :always-short="true" :either-side="6" />
                                <span class="ms-2">

        ...
        @if ($data && $data->count())
            <div class="table-responsive">
                <table class="table table-nowrap align-middle table-striped table-hover top-border">
                    ...
                    <tr>
                        <th>
                            <button type="button" class="btn btn-sort" wire:click="sortBy('give_momentum_reward_percentage')">
                                <x-table-sort-button :sort="$sort" :order="$order" check="give_momentum_reward_percentage" title="Momentum rewards"/>
                            </button>
                        </th>
                        <th>
                            <button type="button" class="btn btn-sort" wire:click="sortBy('give_delegate_reward_percentage')">
                                <x-table-sort-button :sort="$sort" :order="$order" check="give_delegate_reward_percentage" title="Delegate rewards"/>
                            </button>
                        </th>
                        <th>
                    ...
                    @foreach($data as $history)
                        <tr>
                            <td>{{ $history->give_momentum_reward_percentage }}</td>
                            <td>{{ $history->give_delegate_reward_percentage }}</td>

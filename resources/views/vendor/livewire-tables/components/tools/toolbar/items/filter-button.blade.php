    ...
    >
        <div>
            <button
                type="button"
                @class([
                    'btn btn-sm dropdown-toggle btn-outline-primary d-block w-100 d-md-inline' => $this->isBootstrap,
            ...
            >
                <i class="bi bi-funnel-fill me-1"></i> {{ __($this->getLocalisationPath.'Filters') }}

...
export default class Cookie extends Singleton {
    ...
    get(name) {
        if (name === undefined) {
            ...
            Object.entries(cookies).forEach((entry) => {
                ...
                this.zenonHub.globalEvent('cookie.get', cookieName, cookieValue, (newValue) => {
        ...
        this.zenonHub.globalEvent('cookie.get', name, value, (newValue) => {
            value = newValue;
        });
    ...
    set(name, value, options) {
        ...
        this.zenonHub.globalEvent('cookie.set', name, value, (newValue) => {
            saveValue = newValue;
        });

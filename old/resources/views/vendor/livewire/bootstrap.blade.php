<div>
    <nav class="d-lg-flex justify-content-md-between align-items-md-center text-center">
        @if ($paginator->hasPages())
            @php(isset($this->numberOfPaginatorsRendered[$paginator->getPageName()]) ? $this->numberOfPaginatorsRendered[$paginator->getPageName()]++ : $this->numberOfPaginatorsRendered[$paginator->getPageName()] = 1)

            <ul class="pagination justify-content-center justify-content-lg-end mb-4 mb-lg-0">
                {{-- Previous Page Link --}}
        ...
        <p class="small text-muted d-block text-nowrap order-lg-first mb-0">
            Showing

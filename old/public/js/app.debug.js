...
/***/ "./resources/js/abstracts/PluginBase.js":
/*!**********************************************!*\
  !*** ./resources/js/abstracts/PluginBase.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./resources/js/abstracts/Singleton.js":
/*!*********************************************!*\
  !*** ./resources/js/abstracts/Singleton.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _PluginBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./PluginBase */ "./resources/js/abstracts/PluginBase.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, _toPropertyKey(descriptor.key), descriptor); } }
function _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, "prototype", { writable: false }); return Constructor; }
function _toPropertyKey(t) { var i = _toPrimitive(t, "string"); return "symbol" == _typeof(i) ? i : String(i); }
 ...
 *
 * This is a special definition class that the ZenonHub framework will use to interpret the current plugin as a
...
/***/ "./resources/js/main/InnerProxyHandler.js":
/*!************************************************!*\
  !*** ./resources/js/main/InnerProxyHandler.js ***!
  \************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
  ...
  get: function get(target, prop, receiver) {
    if (typeof prop === 'string') {
      ...
      if (['attachAbstracts', 'loadUtilities', 'initialise', 'initialiseSingletons'].includes(prop)) {
        throw new Error("You cannot use the \"".concat(prop, "\" ZenonHub method within a plugin."));
      }
...
/***/ "./resources/js/main/PluginLoader.js":
/*!*******************************************!*\
  !*** ./resources/js/main/PluginLoader.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _abstracts_PluginBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstracts/PluginBase */ "./resources/js/abstracts/PluginBase.js");
/* harmony import */ var _abstracts_Singleton__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../abstracts/Singleton */ "./resources/js/abstracts/Singleton.js");
/* harmony import */ var _InnerProxyHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./InnerProxyHandler */ "./resources/js/main/InnerProxyHandler.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
 ...
 * Plugin loader class.
 *
 * This is a provider (factory) class for a single plugin and provides the link between ZenonHub framework functionality
...
var PluginLoader = /*#__PURE__*/function () {
   ...
   * Constructor.
   *
   * Binds the ZenonHub framework to the instance.
   *
   * @param {string} name
   * @param {ZenonHub} zenonHub
   * @param {PluginBase} instance
   */
  function PluginLoader(name, zenonHub, instance) {
    _classCallCheck(this, PluginLoader);
    this.name = name;
    this.zenonHub = new Proxy(zenonHub, _InnerProxyHandler__WEBPACK_IMPORTED_MODULE_2__["default"]);
  ...
  _createClass(PluginLoader, [{
    ...
    value: function getInstance() {
      ...
      if (!this.dependenciesFulfilled()) {
        var unmet = this.getDependencies().filter(function (item) {
          return !_this.zenonHub.getPluginNames().includes(item);
        });
      ...
      var newInstance = _construct(this.instance, [this.zenonHub].concat(parameters));
    ...
    value: function dependenciesFulfilled() {
      ...
      dependencies.forEach(function (plugin) {
        if (!_this3.zenonHub.hasPlugin(plugin)) {
          fulfilled = false;
        }
      });
      return fulfilled;
...
/***/ "./resources/js/main/ProxyHandler.js":
/*!*******************************************!*\
  !*** ./resources/js/main/ProxyHandler.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ ZenonHub)
/* harmony export */ });
/* harmony import */ var _abstracts_PluginBase__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstracts/PluginBase */ "./resources/js/abstracts/PluginBase.js");
/* harmony import */ var _main_PluginLoader__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../main/PluginLoader */ "./resources/js/main/PluginLoader.js");
/* harmony import */ var _abstracts_Singleton__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../abstracts/Singleton */ "./resources/js/abstracts/Singleton.js");
/* harmony import */ var _utilities_Cookie__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utilities/Cookie */ "./resources/js/utilities/Cookie.js");
/* harmony import */ var _utilities_Modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utilities/Modal */ "./resources/js/utilities/Modal.js");
/* harmony import */ var _utilities_Helpers__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utilities/Helpers */ "./resources/js/utilities/Helpers.js");
/* harmony import */ var _utilities_LoadingScreen__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utilities/LoadingScreen */ "./resources/js/utilities/LoadingScreen.js");
/* harmony import */ var _utilities_Storage__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utilities/Storage */ "./resources/js/utilities/Storage.js");
/* harmony import */ var _utilities_Url__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utilities/Url */ "./resources/js/utilities/Url.js");
/* harmony import */ var _utilities_Core__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../utilities/Core */ "./resources/js/utilities/Core.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _slicedToArray(arr, i) { return _arrayWithHoles(arr) || _iterableToArrayLimit(arr, i) || _unsupportedIterableToArray(arr, i) || _nonIterableRest(); }
function _nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }
 ...
 * ZenonHub
 */
var ZenonHub = /*#__PURE__*/function () {
  /**
   * Constructor.
   *
   ...
   */
  function ZenonHub() {
    var autoSingletons = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    var debug = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
    _classCallCheck(this, ZenonHub);
    ...
    // Freeze the ZenonHub class to prevent further modifications.
    Object.freeze(ZenonHub.prototype);
    Object.freeze(this);
    this.loadUtilities();
    this.initialise();
    this.debug('ZenonHub framework initialised');
  }

  /**
   * Attaches abstract classes as properties of the ZenonHub class.
   *
   * This will allow Javascript functionality with no build process to still extend these abstracts by prefixing
   * them with "ZenonHub".
   *
   * ```
   * class MyClass extends ZenonHub.PluginBase {
   *     ...
   * }
   * ```
   */
  _createClass(ZenonHub, [{
    key: "attachAbstracts",
    value: function attachAbstracts() {
      this.PluginBase = _abstracts_PluginBase__WEBPACK_IMPORTED_MODULE_0__["default"];
      this.Singleton = _abstracts_Singleton__WEBPACK_IMPORTED_MODULE_2__["default"];
    ...
    value: function loadUtilities() {
      ...
      this.addPlugin('helpers', _utilities_Helpers__WEBPACK_IMPORTED_MODULE_5__["default"]);
      this.addPlugin('url', _utilities_Url__WEBPACK_IMPORTED_MODULE_8__["default"]);
      this.addPlugin('storage', _utilities_Storage__WEBPACK_IMPORTED_MODULE_7__["default"]);
      this.addPlugin('core', _utilities_Core__WEBPACK_IMPORTED_MODULE_9__["default"]);
      this.addPlugin('loadingScreen', _utilities_LoadingScreen__WEBPACK_IMPORTED_MODULE_6__["default"]);
      this.addPlugin('modal', _utilities_Modal__WEBPACK_IMPORTED_MODULE_4__["default"]);
    }
     ...
     *
     * Plugins are the cornerstone for additional functionality for ZenonHub. A plugin must either be an ES2015 class
     * that extends the PluginBase or Singleton abstract classes, or a simple callback function.
     *
     * When a plugin is added, it is automatically assigned as a new magic method in the ZenonHub class using the name
     * parameter, and can be called via this method. This method will always be the "lowercase" version of this name.
     *
     * For example, if a plugin is assigned to the name "myPlugin", it can be called via `ZenonHub.myplugin()`.
     *
     * @param {string} name
    ...
    value: function addPlugin(name, instance) {
      ...
      if (this[name] !== undefined || this[lowerName] !== undefined) {
        throw new Error('The given name is already in use for a property or method of the ZenonHub class.');
      }
      this.plugins[lowerName] = new _main_PluginLoader__WEBPACK_IMPORTED_MODULE_1__["default"](lowerName, this, instance);
      ...
      Object.values(this.getPlugins()).forEach(function (plugin) {
        if (plugin.isSingleton() && !plugin.isInitialised() && plugin.dependenciesFulfilled() && plugin.hasMethod('listens') && Object.keys(plugin.callMethod('listens')).includes('ready') && _this2.readiness.dom) {
          _this2.debug("Plugin \"".concat(name, "\" ready"));
     ...
     * Removes a plugin.
     *
     * Removes a plugin from ZenonHub, calling the destructor method for all active instances of the plugin.
     *
     * @param {string} name
     * @returns {void}
     */
     ...
     * attach themselves to ZenonHub immediately but only fire when the DOM is ready.
     *
     * @param {Function} callback
     */
  }, {
        ...
        plugin.getInstances().forEach(function (instance) {
          if (typeof listenMethod === 'function') {
            ...
            try {
              ...
              if (!(_instancePromise instanceof Promise)) {
                return;
              }
    ...
    value: function logMessage(color, bold, message) {
      /* eslint-disable */
      console.groupCollapsed('%c[ZenonHub]', "color: ".concat(color, "; font-weight: ").concat(bold ? 'bold' : 'normal', ";"), message);
...
/***/ "./resources/js/utilities/Cookie.js":
/*!******************************************!*\
  !*** ./resources/js/utilities/Cookie.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Cookie = /*#__PURE__*/function (_Singleton) {
  ...
  _createClass(Cookie, [{
    key: "construct",
    value: function construct() {
      window.zenonHub.debug('cookies ready');
      this.defaults = {
        expires: null,
        path: '/',
        domain: null,
    ...
    value: function get(name) {
      ...
      if (name === undefined) {
        ...
        Object.entries(cookies).forEach(function (entry) {
          ...
          _this3.zenonHub.globalEvent('cookie.get', cookieName, cookieValue, function (newValue) {
      ...
      this.zenonHub.globalEvent('cookie.get', name, value, function (newValue) {
        value = newValue;
      });
      return value;
    }
    ...
    value: function set(name, value, options) {
      ...
      this.zenonHub.globalEvent('cookie.set', name, value, function (newValue) {
        saveValue = newValue;
      });
...
/***/ "./resources/js/utilities/Core.js":
/*!****************************************!*\
  !*** ./resources/js/utilities/Core.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _abstracts_Singleton__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../abstracts/Singleton */ "./resources/js/abstracts/Singleton.js");
...
var Core = /*#__PURE__*/function (_Singleton) {
  _inherits(Core, _Singleton);
  ...
  function Core() {
    ...
    _defineProperty(_assertThisInitialized(_this), "copiersList", null);
    _defineProperty(_assertThisInitialized(_this), "tooltipList", null);
    return _this;
  }
  _createClass(Core, [{
    key: "listens",
    ...
    value: function attachHandlers() {
      ...
      window.livewire.hook('message.received', function (message, component) {
        _this2.offPageGlobals();
      });
      window.livewire.hook('message.processed', function (message, component) {
        _this2.onPageGlobals();
      });
      window.livewire.on('refreshPage', function (refresh) {
        window.location.reload();
      });
    }
  }, {
    key: "onPageGlobals",
    value: function onPageGlobals() {
      this.onFormHandler();
      this.onScrollers();
      this.onTabs();
      this.onCopiers();
    ...
    value: function reopenTab() {
      if (location.hash !== '') {
        var node = document.querySelector('[data-bs-toggle="tab"][href="' + location.hash + '"]');
        if (node) {
          var tab = bootstrap__WEBPACK_IMPORTED_MODULE_1__.Tab.getOrCreateInstance(node);
          tab.show();
        }
      }
    }
    ...
    key: "onFormHandler",
    value: function onFormHandler() {
      var _this3 = this;
      var forms = document.querySelectorAll('.needs-validation');
      Array.from(forms).map(function (form) {
        form.addEventListener('submit', function (event) {
          return _this3.formHandler(form, event);
        });
      });
    }
  }, {
    key: "offFormHandler",
    value: function offFormHandler() {
      var _this4 = this;
      var forms = document.querySelectorAll('.needs-validation');
      Array.from(forms).map(function (form) {
        form.removeEventListener('submit', function (event) {
          return _this4.formHandler(form, event);
        }, false);
      });
    }
  }, {
    key: "onScrollers",
    value: function onScrollers() {
      var _this5 = this;
      var scrollers = document.querySelectorAll('.js-scroll');
      Array.from(scrollers).map(function (element) {
    ...
    key: "offScrollers",
    value: function offScrollers() {
      var _this6 = this;
      var scrollers = document.querySelectorAll('.js-scroll');
      Array.from(scrollers).map(function (element) {
        element.removeEventListener('click', function (event) {
          return _this6.scrollHandler();
        });
      });
    }
  }, {
    key: "onTabs",
    value: function onTabs() {
      var _this7 = this;
      var tabs = document.querySelectorAll('[data-bs-toggle="tab"]');
      Array.from(tabs).map(function (tab) {
        tab.addEventListener('shown.bs.tab', function (event) {
          return _this7.tabClickHandler(event);
        });
      });
    }
  }, {
    key: "offTabs",
    value: function offTabs() {
      var _this8 = this;
      var tabs = document.querySelectorAll('[data-bs-toggle="tab"]');
      Array.from(tabs).map(function (tab) {
        tab.removeEventListener('shown.bs.tab', function (event) {
          return _this8.tabClickHandler(event);
        });
      });
    }
  }, {
    key: "onCopiers",
    value: function onCopiers() {
      var copiersTriggerList = document.querySelectorAll('.js-copy');
      this.copiersList = _toConsumableArray(copiersTriggerList).map(function (copyTriggerEl) {
        return new (clipboard__WEBPACK_IMPORTED_MODULE_2___default())(copyTriggerEl);
      });
    }
  }, {
    key: "offCopiers",
    value: function offCopiers() {
      if (!this.copiersList) {
        return;
      }
      this.copiersList.forEach(function (copier) {
        copier.destroy();
      });
    }
  }, {
    key: "onTooltips",
    value: function onTooltips() {
      var tooltipTriggerList = document.querySelectorAll('[data-bs-toggle="tooltip"]');
      this.tooltipList = _toConsumableArray(tooltipTriggerList).map(function (tooltipTriggerEl) {
        return new bootstrap__WEBPACK_IMPORTED_MODULE_1__.Tooltip(tooltipTriggerEl);
      });
    }
  }, {
    key: "offTooltips",
    value: function offTooltips() {
      if (!this.tooltipList) {
        return;
      }
    ...
    key: "onSyntaxHighlight",
    value: function onSyntaxHighlight() {
      var highlight = document.querySelectorAll('pre > code.lang-json');
      _toConsumableArray(highlight).map(function (highlightEl) {
    ...
    key: "formHandler",
    value: function formHandler(form, event) {
    ...
    value: function tabClickHandler(event) {
      ...
      var stateObject = {
        url: event.target.hash
      };
      window.history.replaceState(stateObject, document.title, window.location.pathname + window.location.search + event.target.hash);
    }
  }]);
  return Core;
...
/***/ "./resources/js/utilities/Helpers.js":
/*!*******************************************!*\
  !*** ./resources/js/utilities/Helpers.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Helpers = /*#__PURE__*/function (_Singleton) {
  _inherits(Helpers, _Singleton);
  var _super = _createSuper(Helpers);
  function Helpers() {
  ...
  _createClass(Helpers, [{
    ...
    value: function scrollToTop() {
      var element = document.querySelector('.js-scroll-to');
      if (element) {
...
/***/ "./resources/js/utilities/LoadingScreen.js":
/*!*************************************************!*\
  !*** ./resources/js/utilities/LoadingScreen.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var LoadingScreen = /*#__PURE__*/function (_Singleton) {
  _inherits(LoadingScreen, _Singleton);
...
/***/ "./resources/js/utilities/Modal.js":
/*!*****************************************!*\
  !*** ./resources/js/utilities/Modal.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Modal = /*#__PURE__*/function (_Singleton) {
  _inherits(Modal, _Singleton);
  ...
  _createClass(Modal, [{
    ...
    value: function ready() {
      ...
      var modalsElement = document.getElementById('laravel-livewire-modals');
      ...
      Livewire.on('showBootstrapModal', function () {
        ...
        if (!modal) {
          modal = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Modal(modalsElement);
        }
...
var _stringifyValue = /*#__PURE__*/new WeakSet();
var _parseValue = /*#__PURE__*/new WeakSet();
var Storage = /*#__PURE__*/function (_Singleton) {
  _inherits(Storage, _Singleton);
  ...
  function Storage() {
    ...
    _this = _super.call.apply(_super, [this].concat(args));
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _parseValue);
    _classPrivateMethodInitSpec(_assertThisInitialized(_this), _stringifyValue);
    return _this;
  }
  _createClass(Storage, [{
    ...
    value: function get(name) {
      ...
      return _classPrivateMethodGet(this, _parseValue, _parseValue2).call(this, value);
    }
  }, {
    key: "put",
    value: function put(name, value) {
      window.sessionStorage.setItem(name, _classPrivateMethodGet(this, _stringifyValue, _stringifyValue2).call(this, value));
    }
  }, {
    key: "push",
    value: function push(name, key, value) {
      var data = this.get(name);
      if (_typeof(data) === 'object') {
        if (Array.isArray(data)) {
          data.push(key, _classPrivateMethodGet(this, _stringifyValue, _stringifyValue2).call(this, value));
        } else {
          data[key] = _classPrivateMethodGet(this, _stringifyValue, _stringifyValue2).call(this, value);
        }
      }
    }
  }, {
    key: "pull",
    value: function pull(name) {
...
function _stringifyValue2(value) {
...
function _parseValue2(value) {
  ...
  if (stringValue.startsWith('base64:')) {
    ...
    return _classPrivateMethodGet(this, _parseValue, _parseValue2).call(this, decoded);
  }
...
var Url = /*#__PURE__*/function (_Singleton) {
  ...
  _createClass(Url, [{
     ...
     *  - If ZenonHub is loaded via the `{% zenonHub %}` tag, it will retrieve the base URL that
    ...
    value: function baseUrl() {
      ...
      if (document.querySelector('script[data-module="zh-base-url"]') !== null) {
        this.foundBaseUrl = this.validateBaseUrl(document.querySelector('script[data-module="zh-base-url"]').dataset.baseUrl);
        return this.foundBaseUrl;
      }
     ...
     *
     * If the ZenonHub script or <base> tag on the page use a different type of URL, this will fail with
     * an error.
     *
     * @param {string} url
     * @returns {string}
...
/* harmony import */ var _main_ProxyHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./main/ProxyHandler */ "./resources/js/main/ProxyHandler.js");
/* harmony import */ var _main_ZenonHub__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./main/ZenonHub */ "./resources/js/main/ZenonHub.js");
...
(function (window) {
  window.zenonHub = new Proxy(new _main_ZenonHub__WEBPACK_IMPORTED_MODULE_2__["default"](true, true), _main_ProxyHandler__WEBPACK_IMPORTED_MODULE_1__["default"]);
})(window);
})();

...
class AccountBlocksOverview extends BaseComponent
{
    public function render(): View
    {
        ...
        return view('livewire.tiles.account-blocks-overview', $stats);
    }

    private function getStats(): array
    {
        return Cache::remember('tile.account-blocks-overview', now()->addMinutes(10), fn () => [
